...
0 &	 $a_\mu$ &	 0.0011659 &	 \cellcolor{green!0} 4.3 $ \sigma$ &	 4.3 $ \sigma$ \\ \hline
1 &	 $\langle \frac{d\overline{\mathrm{BR}}}{dq^2} \rangle(B_s\to \phi \mu^+\mu^-)^{[(2.5,\  4.0)]}$ &	 $4.6797\times 10^{-8}$ &	 \cellcolor{green!32} 3.4 $ \sigma$ &	 4 $ \sigma$ \\ \hline
